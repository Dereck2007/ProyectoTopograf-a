<?php
    ...
    if(isset($_POST["btnCambiarContrasenna"]))
    {
        ...
        if($actualizacion)
        {
            $plantilla = file_get_contents($_SERVER['DOCUMENT_ROOT'] . '/RepoProyectoAmbienteWeb/View/templates/CambioContrasenna.html');
    ...
    if(isset($_POST["btnCambiarPerfil"]))
    {
        ...
        $actualizacion = ActualizarPerfilModel($consecutivo, $nombre, $correoElectronico);
