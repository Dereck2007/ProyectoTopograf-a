                            ...
                            <div class="col-xl-10 col-lg-10">
                                <div class="menu-wrapper d-flex align-items-center justify-content-end">
                                    ...
                                    <div class="main-menu d-none d-lg-block">
                                        <nav>
                                            <ul id="navigation">                                                                                          
                                                <li class="active" ><a href="PantallaInicio.php">Home</a></li>
                                                ...
                                                <!-- Button -->
                                                <li class="button-header margin-left "><a href="RegistroUsuario.php" class="btn">Register</a></li>
                                                <li class="button-header"><a href="InicioSesion.php" class="btn btn3">Log in</a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                </div>
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                <p>experiencias en topografia</p>
                                <h3><a href="#">topografia en hospital</a></h3>
                                <p> un increible equipo de topografia
                                </p>
